...
HTML_IMG_TEMPLATE = """
    ...
    <img src="data:image/png;base64, {}" width="1609px" height="800px"/>
    </a>
    <br></br>
"""
...
class ReportTestResult(unittest.TestResult):
    ...
    def __init__(self, suite, stream=sys.stdout,verbosity=1,retry=0,save_last_try=False):
        """ pass """
...
class BeautifulReport(ReportTestResult, PATH):
    ...
    def __init__(self, suites,verbosity=1,retry=1,save_last_try=True):
    ...
    def report(self, description, filename: str = None, log_path='.'):
        ...
        :return:
        """
        result = ReportTestResult(self.verbosity, self.retry, self.save_last_try)
        if filename:
